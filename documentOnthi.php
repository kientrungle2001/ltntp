...
<html ng-app="flApp" ng-controller="DocumentOnthiController">
<head>
	<meta charset="utf-8">
...
<body>
	...
	<?php include('document/onthi.php'); ?>
	<?php include('common/footer.php'); ?>
	<script src="/assets/angular/documentOnthi.js?t=<?php echo time(); ?>"></script>
</body>
</html>