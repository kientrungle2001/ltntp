...
<html ng-app="flApp" ng-controller="DocumentNewsDetailController">
<head>
	<meta charset="utf-8">
...
<body>
	...
	<?php include('document/newsDetail.php'); ?>
	<?php include('common/footer.php'); ?>
	<script src="/assets/angular/documentNewsDetail.js?t=<?php echo time(); ?>"></script>
</body>
</html>